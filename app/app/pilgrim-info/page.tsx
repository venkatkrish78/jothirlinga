    ...
    <div>
        ...
        <div className="container-custom">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Pilgrim Information Guide
            </h1>
            <p className="text-xl max-w-3xl mx-auto mb-8">
              Essential information for pilgrims visiting the 12 Jyotirlinga temples across India
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              How to <span>Reach</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Information on transportation options to help you plan your journey to the Jyotirlinga temples.
            </p>
          </motion.div>
          ...
          <div className="text-center mt-12">
            <Link href="/travel-planning" className="btn-outline border-green-600 text-green-600 hover:bg-green-50">
      ...
      >
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              <span>Accommodation</span> Options
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Find suitable places to stay during your pilgrimage to the Jyotirlinga temples.
            </p>
          </motion.div>
          ...
          >
            <h3 className="text-xl font-bold text-green-600 dark:text-green-400 mb-4">Booking Tips</h3>
      ...
      >
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              Food and <span>Prasad</span> Availability
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Information about food options and prasad (sacred offerings) at the Jyotirlinga temples.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-12 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6"
          >
            <h3 className="text-xl font-bold text-green-600 dark:text-green-400 mb-4">Special Dietary Considerations</h3>
      ...
      >
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              Facilities for <span>Special Needs</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Information about facilities available for elderly and differently-abled pilgrims.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-12 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6"
          >
            <h3 className="text-xl font-bold text-green-600 dark:text-green-400 mb-4">Additional Resources</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-6">
      ...
      >
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              Safety Tips and <span>Emergency Contacts</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Important safety information and emergency contacts for pilgrims visiting the Jyotirlinga temples.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-12 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6"
          >
            <h3 className="text-xl font-bold text-green-600 dark:text-green-400 mb-4">Emergency Contact Numbers</h3>
      ...
      <section className="py-16 bg-green-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto mb-8">
            Explore detailed information about all 12 Jyotirlinga temples and plan your pilgrimage with our comprehensive guides.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/temples" className="bg-white text-green-600 hover:bg-green-50 px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2">
              <MapPin size={20} />
              Explore Temples
            </Link>
            <Link href="/travel-planning" className="bg-green-700 text-white hover:bg-green-800 px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2">
              <Calendar size={20} />
