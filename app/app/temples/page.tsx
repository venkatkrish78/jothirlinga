        ...
        <div className="container-custom">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              The 12 Sacred Jyotirlinga Temples
            </h1>
            <p className="text-xl max-w-3xl mx-auto mb-8">
              Explore detailed information about each of the twelve sacred abodes of Lord Shiva across India
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100 dark:bg-gray-800">
        <div className="container-custom text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
            Explore our travel planning tools to create your perfect Jyotirlinga pilgrimage itinerary
          </p>
          <Link href="/travel-planning" className="btn-primary">
            <MapPin size={20} />
