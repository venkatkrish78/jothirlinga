    ...
    <div>
        ...
        <div className="container-custom">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Jyotirlinga Pilgrimage Planning
            </h1>
            <p className="text-xl max-w-3xl mx-auto mb-8">
              Plan your sacred journey to the 12 Jyotirlinga temples with our comprehensive travel guides and tools
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              Suggested <span>Pilgrimage Circuits</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Plan your journey with these carefully designed pilgrimage circuits covering multiple Jyotirlinga temples.
            </p>
          </motion.div>
                    ...
                    <div>
                      ...
                      {activeAccordion === circuit.id && (
                        <div className="mt-4 border-t border-gray-100 dark:border-gray-700 pt-4">
                          <h4 className="font-medium mb-3">Suggested Itinerary:</h4>
      ...
      >
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              Seasonal <span>Weather Information</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Understanding the climate at each temple location is crucial for planning a comfortable pilgrimage.
            </p>
          </motion.div>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium">Periods to avoid</p>
      ...
      >
        <div className="container-custom">
          ...
          >
            <h2 className="section-title">
              Comprehensive <span>Packing Checklist</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Ensure you have everything you need for a comfortable and meaningful pilgrimage experience.
            </p>
          </motion.div>
          ...
          >
            <h3 className="text-xl font-bold text-blue-700 dark:text-blue-400 mb-4">Special Items for Kedarnath</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Due to its high altitude and challenging terrain, Kedarnath requires additional preparation:
            </p>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container-custom">
          <h2 className="heading-3 text-center mb-12">General Travel Tips</h2>
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container-custom text-center">
          ...
          <Link href="/temples" className="bg-white text-blue-700 hover:bg-blue-50 px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2 mx-auto w-fit">
            <MapPin size={20} />
            Explore Temples
          </Link>
        </div>
