...
export default function SearchPage({ lng }: SearchPageProps) {
        ...
        <div className="container-custom">
          {isSearching ? (
            ...
            <>
              ...
              >
                {searchTerm.trim() === '' 
                  ? t('search.all_temples')
                  : `${t('search.results_for')} "${searchTerm}" (${searchResults.length} ${t('search.temples_found')})`}
              </motion.h2>
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-2xl font-semibold mb-2">{t('search.no_temples')}</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {t('search.no_temples_desc')}
              </p>
              <button 
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container-custom text-center">
          <h2 className="text-2xl font-bold mb-8">
            {t('search.explore_more')}
          </h2>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href={`/${lng}/temples`} className="bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2 shadow-md">
              <MapPin size={20} className="text-purple-600" />
              {t('search.all_temples_btn')}
            </Link>
            <Link href={`/${lng}/travel-planning`} className="bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2 shadow-md">
              <SearchIcon size={20} className="text-purple-600" />
              {t('search.travel_planning')}
            </Link>
            <Link href={`/${lng}/pilgrim-info`} className="bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2 shadow-md">
              <SearchIcon size={20} className="text-purple-600" />
              {t('search.pilgrim_info')}
            </Link>
          </div>
        </div>
      </section>
