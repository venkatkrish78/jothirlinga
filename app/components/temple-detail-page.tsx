            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    {t('temple_detail.nearest_airport')}: {temple.nearestAirport} ({temple.airportDistance} km)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    {t('temple_detail.nearest_railway')}: {temple.nearestRailway} ({temple.railwayDistance} km)
                  </p>
                </div>
